...
do
    ...
    python -u engine.py \
        ...
        --template_path1=./data/templates/templates_MLEE_full_t1.csv \
        --template_path2=./data/templates/templates_MLEE_full_t2.csv \
        --template_path3=./data/templates/templates_MLEE_full_t3.csv \
        --seed=$SEED \
